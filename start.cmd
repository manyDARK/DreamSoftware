@echo off
REM Modified for DreamTeam by @manyDARK. (All I ask of you is, Please don't remove this line. Or you'll have to deal with a DMCA Take Down.)
...
) else if exist DreamTeam.phar (
    set POCKETMINE_FILE=DreamTeam.phar
) else (
    if exist src\pocketmine\PocketMine.php (
        set POCKETMINE_FILE=src\pocketmine\PocketMine.php
    ) else (
        msg * "ERROR: Couldn't find a valid DreamTeam installation..."
        pause
        exit 1
    )
)
